...
int main()
{
	...
	try
	{
		...
		MixedDistribution <MainDistribution, MainDistribution> mixed_distr(p, main_distr1, main_distr2);
		...
		auto update_scene =
			[&main_distr1, &main_distr2, &mixed_distr, &empirical_distr, &scene, &sample_size, &display_mode, &display_mode_prev]()
		{
		...
		try
		{
			main_distr1.load_from_file("./save1");
		...
		try
		{
			main_distr2.load_from_file("./save2");
			if (display_mode == display_type::none)
			{
		...
		try
		{
			mixed_distr.load_from_file("./save3");
			if (display_mode == display_type::none)
			{
		...
		try
		{
			empirical_distr.load_from_file("./save4");
			if (display_mode == display_type::none)
			{
		...
		while (window.isOpen())
		{
			...
			while (window.pollEvent(event))
			{
				...
				case sf::Event::KeyPressed:
				{
					...
					{
						main_distr1.save_to_file("./save1");
						main_distr2.save_to_file("./save2");
						mixed_distr.save_to_file("./save3");
						empirical_distr.save_to_file("./save4");
					}
